function P_matrix = Initialize_LC_P_matrix_Transfer_Alignment(LC_KF_config)
...
P_matrix(7:9,7:9) = eye(3) * LC_KF_config.init_b_a_unc^2;
P_matrix(10:12,10:12) = eye(3) * LC_KF_config.init_b_g_unc^2;
